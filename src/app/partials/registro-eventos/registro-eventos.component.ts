...
registrar(): void {
  this.errors = this.eventosAcademicosService.validarEvento(this.evento, false);
  ...
  this.eventosAcademicosService.registrarEvento(payload).subscribe(
    () => {
...
actualizar(): void {
  this.errors = this.eventosAcademicosService.validarEvento(this.evento, true);
  if (!this.validarHorario() || !$.isEmptyObject(this.errors)) return;
  ...
  this.eventosAcademicosService.editarEvento(payload).subscribe(
    () => {
  ...
  obtenerEventoPorId(id: any): void {
    this.eventosAcademicosService.getEventoById(id).subscribe(
      (response) => {
